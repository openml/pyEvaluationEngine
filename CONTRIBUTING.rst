...
Welcome to ``pyevaluationengine`` contributor's guide.
...
If you experience bugs or general issues with ``pyevaluationengine``, please have a look
...
You can help improve ``pyevaluationengine`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``pyevaluationengine`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``pyevaluationengine``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/pyevaluationengine.git
    cd pyevaluationengine
...
#. Install |pre-commit|_::
   ...
   ``pyevaluationengine`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/pyevaluationengine
.. _issue tracker: https://github.com/<USERNAME>/pyevaluationengine/issues
.. <-- end -->
